...
---
---
title: 🎞️ Mini Project — “A Day in 6 Clips”
---
![[Pasted image 20251110214207.png]]
# 🎬 Mini Project: *A Day in 6 Clips*
...
Your clips can show moments from your day, a hobby, nature around you, or anything that tells a quick story.
![[Pasted image 20251110214240.png]]
---

### 2️⃣ Import and Organize
- Import your clips into Premiere Pro  
- Create a new sequence  
- Drag your clips into the timeline and arrange them in a logical or creative order  

---

### 3️⃣ Edit and Trim
- Trim your clips so your total video is **30-90 seconds long**  
- Use what you learned in the “Move and Trim Clips” tutorial to make smooth transitions between shots  

---

### 4️⃣ Add Polish
Include the following elements:
- **At least one transition** (e.g., cross dissolve or dip to black)  
- **A short title** at the beginning (e.g., *A Day in 6 Clips*)  
- **Your name** at the end  
- Optional: make **basic color adjustments** or add **background music** (from sample media or royalty-free sites)  
![[Pasted image 20251110214417.png]]
---
...
## 💡 Learning Goals
- Apply the full Premiere Pro workflow: **import → edit → trim → title → export**  
- Build comfort using the Premiere Pro interface  
