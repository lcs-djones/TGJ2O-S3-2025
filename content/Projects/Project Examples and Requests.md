...
# 🧭 Project Ideas, Requests, and Important Dates

This mod is designed to give you **maximum freedom** to pursue your own creative project.

Most students should be **coming up with their own idea**.  
This page is mainly for:
- Students who are **truly stuck**
- Projects that the school has **specifically requested**

If you already have a strong idea, you do **not** need to use anything from this page.

---

## 🎯 Important Context

This open project format exists to:
- Promote **independent thinking**
- Encourage **original ideas**
- Let you work like a real creator

The ideas below are **supports**, not defaults.

---

## 📌 Specific Project Requests (Already Approved)
...
## 💡 General Project Idea Starters

Use these only if you need a starting point.
...
### 🖼️ Photoshop
- Posters or graphics for school events
- Infographics for school initiatives
- Visual assets for clubs or teams

### 🛠️ 3D Printing
- Functional items for classrooms or clubs
- Awards, signage, or props
- Tools or organizers designed for real use
...
If you are stuck:
1. Look for real needs around the school  
2. Check upcoming dates  
3. Talk to peers  
4. Then talk to Mr. Jones  

If needed, you can be assigned a project — but this mod is meant to be **student-driven**.